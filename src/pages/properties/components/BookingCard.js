...
const BookingCard = (props) => {
  ...
  const [message, setMessage] = useState(
    `I am intreasted in this property. [${property?._id}]`
  );
  ...
  const handelBooking = () => {
    axios
      ...
      .then(
        ...
        setUsername(""),
        setEmail(""),
        setMessage(`I am intreasted in this property. [${property?._id}]`)
      )
      .catch((err) => {
          ...
          <form id="checkout-form">
            <div className=" mb-1">
              <div className="w-100 me-2">
                <label htmlFor="username" className="h6 text-secondary text-sm">
                  username
                </label>
              ...
              <div className="w-100">
                <label htmlFor="email" className="h6 text-secondary text-sm">
                  email
                </label>
                <div className="d-flex justify-content-start align-items-center border bg-white">
                  <i className="text-secondary fas fa-envelope text-sm mx-2"></i>
                  <input
              ...
              <div className="w-100">
                <label htmlFor="contact" className="h6 text-secondary text-sm">
                  Contact
                </label>
                <div className="d-flex justify-content-start align-items-center border bg-white">
                  <i className="text-secondary fas fa-phone text-sm mx-2"></i>
                  <input
              ...
              <div className="w-100">
                <label htmlFor="message" className="h6 text-secondary text-sm">
                  Message
                </label>
                <div className="d-flex justify-content-start align-items-center border bg-white">
                  <textarea
