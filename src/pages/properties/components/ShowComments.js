...
const ShowComments = (props) => {
  ...
  useEffect(() => {
    axios
      .get("/show-comments/" + props.propertyId.toString())
      .then(function (res) {
            ...
            <>
              {comments.map((val, ind) => {
                return (
                  <div
                    key={val}
                    className="d-flex flex-wrap my-3 rounded px-2 py-2"
                  ...
                  >
                    <div className="mx-2">
                      ...
                      <small className="text-xs mx-1 text-muted">
                      ...
                      <div className="d-flex">
                        {val.likedBy.indexOf(user?._id) !== -1 ? (
                          <>
                            ...
                            >
                              <small id={`like${val._id}`} className="text-sm">
                                {val.likes}
                              </small>
                              <i
                                id={`heart${val._id}`}
                                className={`fa-solid fa-heart mx-1 text-sm text-primary`}
                                style={{ color: "#afafaf" }}
                              ></i>
                            </button>
                          </>
                          ...
                          <>
                            ...
                            >
                              ...
                              <i
                                id={`heart${val._id}`}
                                className={`fa-solid fa-heart mx-1 text-sm`}
                                style={{ color: "#afafaf" }}
                              ></i>
                            </button>
                          </>
